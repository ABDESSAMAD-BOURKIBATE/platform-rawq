...
import { canadaToronto } from './canada-toronto';
import { canadaVancouver } from './canada-vancouver';
...
import { brazilRio } from './brazil-rio';
import { brazilManaus } from './brazil-manaus';
...
import { australiaSydney } from './australia-sydney';
import { australiaPerth } from './australia-perth';
...
export const COUNTRY_DETAILS_REFACTORED = {
    ...
    "Canada (Toronto)": canadaToronto,
    "Canada (Vancouver)": canadaVancouver,
    "Mexico": mexico,
    "Cuba": cuba,
    "Jamaica": jamaica,
    "Panama": panama,
    ...
    "Haiti": haiti,
    "Brazil (Rio)": brazilRio,
    "Brazil (Manaus)": brazilManaus,
    "Argentina": argentina,
    "Chile": chile,
    "Colombia": colombia,
    "Peru": peru,
