...
const COUNTRIES: CountryTime[] = [
    ...
    { name: 'Bosnia and Herzegovina', nameAr: 'البوسنة والهرسك', nameFr: 'Bosnie-Herzégovine', city: 'SARAJEVO', cityAr: 'سراييفو', cityFr: 'Sarajevo', timezone: 'Europe/Sarajevo', flag: '🇧🇦', continent: 'europe' },
    ...
    { name: 'Slovakia', nameAr: 'سلوفاكيا', nameFr: 'Slovaquie', city: 'BRATISLAVA', cityAr: 'براتيسلافا', cityFr: 'Bratislava', timezone: 'Europe/Bratislava', flag: '🇸🇰', continent: 'europe' },
    { name: 'Moldova', nameAr: 'مولدوفا', nameFr: 'Moldavie', city: 'CHISINAU', cityAr: 'كيشيناو', cityFr: 'Chisinau', timezone: 'Europe/Chisinau', flag: '🇲🇩', continent: 'europe' },
    { name: 'Lithuania', nameAr: 'ليتوانيا', nameFr: 'Lituanie', city: 'VILNIUS', cityAr: 'فيلنيوس', cityFr: 'Vilnius', timezone: 'Europe/Vilnius', flag: '🇱🇹', continent: 'europe' },
    { name: 'North Macedonia', nameAr: 'مقدونيا الشمالية', nameFr: 'Macédoine du Nord', city: 'SKOPJE', cityAr: 'إسكوبية', cityFr: 'Skopje', timezone: 'Europe/Skopje', flag: '🇲🇰', continent: 'europe' },
    { name: 'Slovenia', nameAr: 'سلوفينيا', nameFr: 'Slovénie', city: 'LJUBLJANA', cityAr: 'ليوبليانا', cityFr: 'Ljubljana', timezone: 'Europe/Ljubljana', flag: '🇸🇮', continent: 'europe' },
    { name: 'Latvia', nameAr: 'لاتفيا', nameFr: 'Lettonie', city: 'RIGA', cityAr: 'ريغا', cityFr: 'Riga', timezone: 'Europe/Riga', flag: '🇱🇻', continent: 'europe' },
    { name: 'Estonia', nameAr: 'إستونيا', nameFr: 'Estonie', city: 'TALLINN', cityAr: 'تالين', cityFr: 'Tallinn', timezone: 'Europe/Tallinn', flag: '🇪🇪', continent: 'europe' },
    { name: 'Montenegro', nameAr: 'الجبل الأسود', nameFr: 'Monténégro', city: 'PODGORICA', cityAr: 'بودغوريتسا', cityFr: 'Podgorica', timezone: 'Europe/Podgorica', flag: '🇲🇪', continent: 'europe' },
    { name: 'Luxembourg', nameAr: 'لوكسمبورغ', nameFr: 'Luxembourg', city: 'LUXEMBOURG', cityAr: 'لوكسمبورغ', cityFr: 'Luxembourg', timezone: 'Europe/Luxembourg', flag: '🇱🇺', continent: 'europe' },
    { name: 'Malta', nameAr: 'مالطا', nameFr: 'Malte', city: 'VALLETTA', cityAr: 'فاليتا', cityFr: 'La Valette', timezone: 'Europe/Malta', flag: '🇲🇹', continent: 'europe' },
    { name: 'Cyprus', nameAr: 'قبرص', nameFr: 'Chypre', city: 'NICOSIA', cityAr: 'نيقوسيا', cityFr: 'Nicosie', timezone: 'Asia/Nicosia', flag: '🇨🇾', continent: 'europe' },
    { name: 'Andorra', nameAr: 'أندورا', nameFr: 'Andorre', city: 'ANDORRA LA VELLA', cityAr: 'أندورا لا فيلا', cityFr: 'Andorre-la-Vieille', timezone: 'Europe/Andorra', flag: '🇦🇩', continent: 'europe' },
    { name: 'Monaco', nameAr: 'موناكو', nameFr: 'Monaco', city: 'MONACO', cityAr: 'موناكو', cityFr: 'Monaco', timezone: 'Europe/Monaco', flag: '🇲🇨', continent: 'europe' },
    { name: 'Liechtenstein', nameAr: 'ليختنشتاين', nameFr: 'Liechtenstein', city: 'VADUZ', cityAr: 'فادوز', cityFr: 'Vaduz', timezone: 'Europe/Vaduz', flag: '🇱🇮', continent: 'europe' },
    { name: 'San Marino', nameAr: 'سان مارينو', nameFr: 'Saint-Marin', city: 'SAN MARINO', cityAr: 'سان مارينو', cityFr: 'Saint-Marin', timezone: 'Europe/San_Marino', flag: '🇸🇲', continent: 'europe' },
    { name: 'Vatican City', nameAr: 'الفاتيكان', nameFr: 'Vatican', city: 'VATICAN CITY', cityAr: 'الفاتيكان', cityFr: 'Vatican', timezone: 'Europe/Vatican', flag: '🇻🇦', continent: 'europe' },
    { name: 'Kosovo', nameAr: 'كوسوفو', nameFr: 'Kosovo', city: 'PRISTINA', cityAr: 'بريشتينا', cityFr: 'Pristina', timezone: 'Europe/Belgrade', flag: '🇽🇰', continent: 'europe' },
    { name: 'Belarus', nameAr: 'بيلاروسيا', nameFr: 'Biélorussie', city: 'MINSK', cityAr: 'مينسك', cityFr: 'Minsk', timezone: 'Europe/Minsk', flag: '🇧🇾', continent: 'europe' },
